...
const Register = props => {
    ...
    const validateData = data => {
        ...
        if (!data?.contactNumber) {
            ...
            if (!data?.contactNumber?.countryCode) {
                emptyFields.push("countryCode")
                isValid = false;
            }
    ...
    const onNameChange = value => {
        setEmptyFieldsValidation(prev => {
            return _.pull(prev, "name");
        })
        setName(value);
    }
    const onEmailChange = value => {
        setEmptyFieldsValidation(prev => {
            return _.pull(prev, "email");
        })
        setEmail(value);
    }
    const onPasswordChange = value => {
        setEmptyFieldsValidation(prev => {
            return _.pull(prev, "password");
        })
        setPassword(value);
    }
    const onPhoneNumberChange = value => {
        setEmptyFieldsValidation(prev => {
            return _.pull(prev, "phone");
        })
        ...
        <PageViewContainer>
            <RegisterWrapper>
                ...
                <InputV2
                    ...
                    required={true}
                    error={emptyFieldsValidation.includes("name")}
                ...
                <InputV2
                    ...
                    error={emptyFieldsValidation.includes("email")}
                    errorMessage={"Required Field"}
                />
                ...
                <InputV2
                    ...
                    error={emptyFieldsValidation.includes("password")}
                    errorMessage={"Required Field"}
                />
                ...
                <InputV2
                    ...
                    groupClassName={"phone-input-container"}
                    error={emptyFieldsValidation.includes("phone")}
                    errorMessage={"Required Field"}
                >
                    <SelectV2
                        id={"country-code"}
                        ...
                        label={"Country Code"}
                        groupClassName={"country-code-input-container"}
                    >
